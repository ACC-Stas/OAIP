...
int main() {
	...
	linkedMap<int, int>::Iterator it3 = bst3.begin();
	...
	std::cout << (*it3).first << " " << (*it3).second << '\n';
	std::cout << "Testing linkedSet\n";
	linkedSet<int> st1;
	st1.insert(5);
	st1.insert(-4);
	st1.insert(10);
	st1.insert(11);
	linkedSet<int>::Iterator itS = st1.begin();
	for (; itS != st1.end(); ++itS) {
		std::cout << *itS << '\n';
	}
	std::cout << *itS << '\n';
